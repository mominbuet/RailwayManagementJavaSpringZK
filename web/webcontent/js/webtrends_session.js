...
function WebTrends(){
	...
	this.dcsid="dcsn42u4k11e5hyzziz7zntl5_1j8l";
	this.domain="statse.webtrendslive.com";
	this.timezone=-8;
	this.fpcdom=".amtrak.com";
	this.onsitedoms="www.amtrak.com, tickets.amtrak.com, espanol.amtrak.com, francais.amtrak.com, deutsch.amtrak.com, whistlestop.amtrak.com, m.amtrak.com, stations.amtrak.com";
...
WebTrends.prototype.dcsVar=function(){
	...
	if (window.location.hostname=='stations.amtrak.com'){
              DCS.dcsqry=MQ_dcsqry;
        } else {

	if (window.location.search){
		DCS.dcsqry=CMS_dcsqry;
	}
	}
	if (DCS.dcsqry){
